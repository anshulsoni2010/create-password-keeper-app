...
function deleteItems() {
  const confirmAction = confirm("Are you sure to delete all items?");
  if (confirmAction) {
    // if true
    let deleteItems = window.localStorage.clear();
    alert("All items has deleted successfully");
    refresh();
  } else {
    // if false
